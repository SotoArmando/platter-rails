...
class InstructionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instruction" do
    assert_difference("Instruction.count") do
      post instructions_url, params: { instruction: { name: @instruction.name, number: @instruction.number, recipe_id: @instruction.recipe_id } }
    end
  ...
  test "should update instruction" do
    patch instruction_url(@instruction), params: { instruction: { name: @instruction.name, number: @instruction.number, recipe_id: @instruction.recipe_id } }
